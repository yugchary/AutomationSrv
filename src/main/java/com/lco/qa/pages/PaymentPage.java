...
public class PaymentPage extends TestBase {
	...
	public PaymentPage SampleTest(String un, String pwd) {
		...
		// processPage.ProcessFields("agent", itrCount, "Agent", "Email E Signature",
		// "eft");
		// processPage.ProcessFields("customer", itrCount, "Customer", "In Person E
		// Signature", "cc");
	...
	public boolean makePayment(int rowNum, String paymentType) {
		...
		try {
			...
			Testutil.staticLongWait();
			driver.quit();
			signaturePage.EmailSign(rowNum, "SIGN PAYMENT FORM",
					"Thank you! Your application has been submitted, we will be in touch with you shortly.",
					"Customer Payment form signature");
			agentWebHomePage.validateQuotationsnEApplications();
			/*
			 * ProductUtil.clickButton("Continue to Customer Signature");
			 * Testutil.staticLongWait(); signaturePage.signDoc();
			 * Testutil.staticLongWait();
			 */
